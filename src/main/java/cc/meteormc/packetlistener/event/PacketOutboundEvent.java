...
public class PacketOutboundEvent extends PacketEvent {
    ...
    /**
     * Creates a {@link PacketOutboundEvent}.
     *
     ...
     */
    public PacketOutboundEvent(@NotNull ChannelHandlerContext ctx, @Nullable GameProfile profile, @Nullable Player player, @NotNull Packet packet) {
